     ...
     @if($provinces!=null)
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm levelCombo"
                                                        ...
                                                        style="width: 100%;" name="province" disabled=true>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="code" type="text" class="form-control form-control-sm"
                                                       ...
                                                       value="{{$localAuthority['laCode']}}" disabled>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        ...
                                        <h3 class="card-title"><b>Remove '{{$localAuthority['name']}}' Institute
...
//Load ZOne
loadZoneCombo($(".levelCombo").val(),function(){
    
$("#loadZone").val({{$localAuthority['zone_id']}})
