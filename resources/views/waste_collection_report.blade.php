    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-12 col-sm-6">
                     <h1>Waste Collection Reports</h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
<p>Contins all the row Waste Collection data </p>

                    </div>
                    <div class="card-footer">                   
                           <a href="/row_waste_collection_report" target="_blank"  type="" class="btn btn-success">Show</a>
          </div>                           
                </div>
            ...
            <!-- industry category -->
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <label id="lblTitle">Waste Collection Report 2</label>
                    </div>
                    <div class="card-body">
<p>Waste Collection Report 2</p>
            ...
            <!-- end industry category -->
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <label id="lblTitle">Waste Collection Report 3</label>
                    </div>
                    <div class="card-body">
<p>Waste Collection Report 3</p>
            ...
            <!-- end transfer_satation_report -->
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <label id="lblTitle">Waste Collection Report 4</label>
                    </div>
                    <div class="card-body">
<p>Waste Collection Report 4</p>
            ...
            <!-- end dump_site_report -->
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <label id="lblTitle">Waste Collection Report 5</label>
                    </div>
                    <div class="card-body">
<p>Waste Collection Report 5</p>
