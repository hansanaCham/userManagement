...
{{--    <h1>{{$p['name']}}</h1>--}}
        <section class="content-header">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                                    ...
                                    <form method="POST" action="/vehicle/id/{{$vehicle['id']}}">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="height" type="number" id="txtHeight" step="0.01" class="form-control form-control-sm" required
                      ...
                      <div class="icheck-primary d-inline">
                        <input type="checkbox" id="chkOnlyCapasity" checked="false">
                        <label for="chkOnlyCapasity">Only Capacity</label>
                      </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input readonly name="capacity" type="number" step="0.01" id="txtCapacity" class="form-control form-control-sm" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="bland" type="text" class="form-control form-control-sm" required
                                                       placeholder="Enter Vehcle Brand"
                                                       value="{{$vehicle['bland']}}">
                                                @error('bland')
                ...
                <script>
$(function () {
    $('#chkOnlyCapasity').prop("checked",false);
...
//Auto Cal Capacity
$('input[name="height"],input[name="wide"],input[name="length"]').keyup(function () {
    var width = $('input[name="wide"]').val();
    ...
    $('input[name="capacity"]').val(width * height * length);
});



$('#chkOnlyCapasity').change(function(){
       if($(this).prop("checked") == true){
      $('input[name="wide"]').val(0);
     $('input[name="height"]').val(0);
    $('input[name="length"]').val(0);
          $("#wdth_length_hight").addClass('d-none');
                             $("#txtCapacity").prop('readonly', false);
   $("#txtCapacity").attr('disabled', false);
            ...
            {
                 $('txtCapacity').val(0);
 $("#wdth_length_hight").removeClass('d-none');
                       $("#txtCapacity").prop('readonly', true);
