...
<!--                                                                                                                                    <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm clusterCombo"
                                                    ...
                                                    @if (old('is_cluster') == 0)
                                                    <option selected value="1" selected>Yes</option>
