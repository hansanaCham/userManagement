                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="wdth_length_hight"> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="height" id="txtHeight" type="number" step="0.01" class="form-control form-control-sm" required
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input readonly id="txtCapacity" name="capacity" type="number" step="0.01" class="form-control form-control-sm" 
