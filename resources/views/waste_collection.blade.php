...
<section class="content-header">
 ...
 <select class="form-control form-control-sm select2  select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;" 
 id="local_authority_combo">
                                                    ...
                                                    <div id="temp_vehicle_section" class="d-none">
                                                        <div class="form-group">
                                                            <select class="form-control form-control-sm select2  select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;" id="is_reg_veh">
                                                        ...
                                                        <div class="form-group" id="temp_veh_combo_div">
                                                            <label>Select Hired Vehicle</label>
                                                    ...
                                                    <div id="reg_vehicle_section">
                                                        <div class="form-group" id="">
                                                            ...
                                                            <select class="form-control form-control-sm vehicleCombo select2  select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;" id="vehicleNumberCombo"></select>                                            
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Driver</label>
                                                        <select class="form-control form-control-sm destiTypeCombo select2  select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;" id="driverCombo">
...
<script>
    ...
    $(function () {
        ...
        $('.select2').select2();
         ...
         comboSession();
        localAuthorityComboWasteCollection(function () {
        mainCollection_Table($("#local_authority_combo").val());
      vehicleByLa_Combo($("#local_authority_combo").val());
         wardCombo($("#local_authority_combo").val());
         comboDriver($("#local_authority_combo").val());
        }
...
wasteType_Combo(function () {
 ...
 ratio_Combo();
        ...
        $('#local_authority_combo').change(function () {
             mainCollection_Table($("#local_authority_combo").val());
       vehicleByLa_Combo($("#local_authority_combo").val());
        comboDriver($("#local_authority_combo").val());
          wardCombo($("#local_authority_combo").val());
        ...
        $('#btnSave').click(function () {
            save_collection(getFormVal(), function () {
                mainCollection_Table($("#local_authority_combo").val());
            });
        });
