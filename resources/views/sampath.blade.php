            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <label>Recyclable Waste Store Registration</label>
                                </div>
                                    ...
                                    <div class="card-body">
                                     ...
                                     @if($pro!=null || $provinces!=null)
                                       ...
                                       @endif                                        
                                        ...
                                        <div class="form-group">
                                            <label>Recyclable Waste Store Name</label>
                    ...
                    <div class="col-md-7">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">All Recyclable Waste Store</h3>
                            </div>
                            <div class="card-body">
