            ...
            <div class="col-md-5">
                <div class="card card-primary">
                    <div class="card-header">
                        <label id="lblTitle">Add New Driver</label>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>NIC</label>
                            <input id="getNic" maxlength="12" type="text" class="form-control form-control-sm" placeholder="Enter NIC Number..." value="">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="card-body table-responsive" style="height: 450px;">
                                            <table class="table table-bordered table-striped" id="tblDrivers">
                                                <thead>
                                                    <tr>
...
<script src="../../js/DriverJS/submit.js"></script>
<script src="../../js/DriverJS/get.js"></script>
<script src="../../js/DriverJS/update.js"></script>
<script src="../../js/DriverJS/delete.js"></script>
<!-- AdminLTE App -->
<script>
    $(function () {
            ...
            if (Validiteinsert(data)) {
                ...
                if (data.nic.length !== 0) {
                    uniqueNICcheck(data.nic, function (r) {
                        if (r.message == 'true') {
                            AddDriver(data, function (result) {
                                if (result.id == 1) {
                                    Toast.fire({
                                        type: 'success',
...
//click update button
        $('#btnUpdate').click(function () {
            ...
            if (Validiteupdate(data)) {
                updateDriver($('#btnUpdate').val(), data, function (result) {
                    if (result.id == 1) {
                        Toast.fire({
                            type: 'success',
...
//click delete button
        $('#btnDelete').click(function () {
            deleteDriver($('#btnDelete').val(), function (result) {
                if (result.id == 1) {
                    Toast.fire({
                        type: 'success',
